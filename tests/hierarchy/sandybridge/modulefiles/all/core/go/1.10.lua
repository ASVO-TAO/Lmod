...
local root = "/apps/sandybridge/software/core/go/1.10"

conflict("go")
prepend_path("MODULEPATH", "/apps/sandybridge/modulefiles/all/compiler/go/1.10")
...
setenv("GOROOT", "/apps/sandybridge/software/core/go/1.10")
