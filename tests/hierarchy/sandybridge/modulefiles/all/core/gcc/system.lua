...
local root = "/apps/sandybridge/software/core/gcc/system"
...
prepend_path("MODULEPATH", "/apps/sandybridge/modulefiles/all/compiler/gcc/system")

setenv("EBROOTGCC", "/apps/sandybridge/software/core/gcccore/system")
