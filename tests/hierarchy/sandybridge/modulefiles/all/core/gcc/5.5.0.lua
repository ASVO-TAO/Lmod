...
local root = "/apps/sandybridge/software/core/gcc/5.5.0"
...
prepend_path("MODULEPATH", "/apps/sandybridge/modulefiles/all/compiler/gcc/5.5.0")

setenv("EBROOTGCC", "/apps/sandybridge/software/core/gcccore/5.5.0")
