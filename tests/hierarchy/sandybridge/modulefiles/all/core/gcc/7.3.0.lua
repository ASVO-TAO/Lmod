...
local root = "/apps/sandybridge/software/core/gcc/7.3.0"
...
prepend_path("MODULEPATH", "/apps/sandybridge/modulefiles/all/compiler/gcc/7.3.0")

setenv("EBROOTGCC", "/apps/sandybridge/software/core/gcccore/7.3.0")
