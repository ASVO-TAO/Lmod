...
local root = "/apps/sandybridge/software/core/anaconda3/5.0.1"
...
setenv("EBVERSIONANACONDA3", "5.0.1")
setenv("EBDEVELANACONDA3", pathJoin(root, "easybuild/core-anaconda3-5.0.1-easybuild-devel"))
