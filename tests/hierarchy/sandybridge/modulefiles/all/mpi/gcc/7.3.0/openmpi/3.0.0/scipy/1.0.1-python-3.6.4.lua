...
local root = "/apps/sandybridge/software/mpi/gcc/7.3.0/openmpi/3.0.0/scipy/1.0.1-python-3.6.4"
...
if not isloaded("numpy/1.14.2-python-3.6.4") then
    load("numpy/1.14.2-python-3.6.4")
end

setenv("EBROOTSCIPY", root)
setenv("EBVERSIONSCIPY", "1.0.1")
setenv("EBDEVELSCIPY", pathJoin(root, "easybuild/mpi-gcc-7.3.0-openmpi-3.0.0-scipy-1.0.1-python-3.6.4-easybuild-devel"))
