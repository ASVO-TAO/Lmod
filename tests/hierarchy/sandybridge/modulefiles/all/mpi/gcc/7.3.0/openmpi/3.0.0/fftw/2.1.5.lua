...
local root = "/apps/sandybridge/software/mpi/gcc/7.3.0/openmpi/3.0.0/fftw/2.1.5"
...
setenv("EBDEVELFFTW", pathJoin(root, "easybuild/mpi-gcc-7.3.0-openmpi-3.0.0-fftw-2.1.5-easybuild-devel"))
