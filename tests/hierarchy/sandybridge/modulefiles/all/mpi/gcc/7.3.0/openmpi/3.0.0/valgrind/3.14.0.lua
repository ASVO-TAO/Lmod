...
local root = "/apps/sandybridge/software/mpi/gcc/7.3.0/openmpi/3.0.0/valgrind/3.14.0"
...
setenv("EBDEVELVALGRIND", pathJoin(root, "easybuild/mpi-gcc-7.3.0-openmpi-3.0.0-valgrind-3.14.0-easybuild-devel"))
