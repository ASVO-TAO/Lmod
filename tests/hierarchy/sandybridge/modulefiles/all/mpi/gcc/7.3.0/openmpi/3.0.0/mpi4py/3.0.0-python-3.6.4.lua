...
local root = "/apps/sandybridge/software/mpi/gcc/7.3.0/openmpi/3.0.0/mpi4py/3.0.0-python-3.6.4"
...
setenv("EBDEVELMPI4PY", pathJoin(root, "easybuild/mpi-gcc-7.3.0-openmpi-3.0.0-mpi4py-3.0.0-python-3.6.4-easybuild-devel"))
