...
local root = "/apps/sandybridge/software/mpi/gcc/7.3.0/openmpi/3.0.0/h5py/2.7.1-python-3.6.4"
...
setenv("EBDEVELH5PY", pathJoin(root, "easybuild/mpi-gcc-7.3.0-openmpi-3.0.0-h5py-2.7.1-python-3.6.4-easybuild-devel"))
