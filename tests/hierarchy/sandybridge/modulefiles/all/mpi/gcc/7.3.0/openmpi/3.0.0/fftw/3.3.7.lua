...
local root = "/apps/sandybridge/software/mpi/gcc/7.3.0/openmpi/3.0.0/fftw/3.3.7"
...
setenv("EBDEVELFFTW", pathJoin(root, "easybuild/mpi-gcc-7.3.0-openmpi-3.0.0-fftw-3.3.7-easybuild-devel"))
