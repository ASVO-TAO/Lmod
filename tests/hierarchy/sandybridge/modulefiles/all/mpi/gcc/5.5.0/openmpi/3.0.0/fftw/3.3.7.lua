...
local root = "/apps/sandybridge/software/mpi/gcc/5.5.0/openmpi/3.0.0/fftw/3.3.7"
...
setenv("EBDEVELFFTW", pathJoin(root, "easybuild/mpi-gcc-5.5.0-openmpi-3.0.0-fftw-3.3.7-easybuild-devel"))
