...
local root = "/apps/sandybridge/software/mpi/gcc/5.5.0/openmpi/3.0.0/netcdf/4.5.0"
...
setenv("EBDEVELNETCDF", pathJoin(root, "easybuild/mpi-gcc-5.5.0-openmpi-3.0.0-netcdf-4.5.0-easybuild-devel"))
