...
local root = "/apps/sandybridge/software/mpi/gcc/6.4.0/openmpi/3.0.0/plplot/5.13.0-java-1.8.0_162-python-2.7.14"
...
setenv("EBDEVELPLPLOT", pathJoin(root, "easybuild/mpi-gcc-6.4.0-openmpi-3.0.0-plplot-5.13.0-java-1.8.0_162-python-2.7.14-easybuild-devel"))
