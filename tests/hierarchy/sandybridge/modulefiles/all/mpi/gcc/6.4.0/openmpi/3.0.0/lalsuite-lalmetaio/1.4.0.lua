...
local root = "/apps/sandybridge/software/mpi/gcc/6.4.0/openmpi/3.0.0/lalsuite-lalmetaio/1.4.0"
...
setenv("EBVERSIONLALSUITEMINLALMETAIO", "1.4.0")
setenv("EBDEVELLALSUITEMINLALMETAIO", pathJoin(root, "easybuild/mpi-gcc-6.4.0-openmpi-3.0.0-lalsuite-lalmetaio-1.4.0-easybuild-devel"))
