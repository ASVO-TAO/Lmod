...
local root = "/apps/sandybridge/software/mpi/gcc/6.4.0/openmpi/3.0.0/mpi4py/3.0.0-python-2.7.14"
...
setenv("EBDEVELMPI4PY", pathJoin(root, "easybuild/mpi-gcc-6.4.0-openmpi-3.0.0-mpi4py-3.0.0-python-2.7.14-easybuild-devel"))
