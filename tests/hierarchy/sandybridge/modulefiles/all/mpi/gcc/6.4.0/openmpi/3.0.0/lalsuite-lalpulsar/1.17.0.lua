...
local root = "/apps/sandybridge/software/mpi/gcc/6.4.0/openmpi/3.0.0/lalsuite-lalpulsar/1.17.0"

conflict("lalsuite-lalpulsar")
...
setenv("EBROOTLALSUITEMINLALPULSAR", root)
setenv("EBVERSIONLALSUITEMINLALPULSAR", "1.17.0")
setenv("EBDEVELLALSUITEMINLALPULSAR", pathJoin(root, "easybuild/mpi-gcc-6.4.0-openmpi-3.0.0-lalsuite-lalpulsar-1.17.0-easybuild-devel"))
