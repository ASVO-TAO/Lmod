...
local root = "/apps/sandybridge/software/mpi/gcc/6.4.0/openmpi/3.0.0/tensorflowgpu/1.6.0-python-3.6.4"
...
setenv("EBDEVELTENSORFLOWGPU", pathJoin(root, "easybuild/mpi-gcc-6.4.0-openmpi-3.0.0-tensorflowgpu-1.6.0-python-3.6.4-easybuild-devel"))
