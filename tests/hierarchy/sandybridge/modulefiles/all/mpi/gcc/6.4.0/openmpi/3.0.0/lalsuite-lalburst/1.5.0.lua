...
local root = "/apps/sandybridge/software/mpi/gcc/6.4.0/openmpi/3.0.0/lalsuite-lalburst/1.5.0"
...
setenv("EBVERSIONLALSUITEMINLALBURST", "1.5.0")
setenv("EBDEVELLALSUITEMINLALBURST", pathJoin(root, "easybuild/mpi-gcc-6.4.0-openmpi-3.0.0-lalsuite-lalburst-1.5.0-easybuild-devel"))
