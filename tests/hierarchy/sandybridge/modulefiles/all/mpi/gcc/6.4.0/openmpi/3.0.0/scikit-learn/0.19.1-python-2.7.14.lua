...
local root = "/apps/sandybridge/software/mpi/gcc/6.4.0/openmpi/3.0.0/scikit-learn/0.19.1-python-2.7.14"
...
setenv("EBDEVELSCIKITMINLEARN", pathJoin(root, "easybuild/mpi-gcc-6.4.0-openmpi-3.0.0-scikit-learn-0.19.1-python-2.7.14-easybuild-devel"))
