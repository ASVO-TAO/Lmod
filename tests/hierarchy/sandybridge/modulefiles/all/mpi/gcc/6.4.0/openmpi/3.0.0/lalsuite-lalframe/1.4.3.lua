...
local root = "/apps/sandybridge/software/mpi/gcc/6.4.0/openmpi/3.0.0/lalsuite-lalframe/1.4.3"
...
setenv("EBVERSIONLALSUITEMINLALFRAME", "1.4.3")
setenv("EBDEVELLALSUITEMINLALFRAME", pathJoin(root, "easybuild/mpi-gcc-6.4.0-openmpi-3.0.0-lalsuite-lalframe-1.4.3-easybuild-devel"))
