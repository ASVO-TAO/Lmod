...
local root = "/apps/sandybridge/software/mpi/gcc/6.4.0/openmpi/3.0.0/pygpu/0.7.5-python-3.6.4"
...
setenv("EBDEVELPYGPU", pathJoin(root, "easybuild/mpi-gcc-6.4.0-openmpi-3.0.0-pygpu-0.7.5-python-3.6.4-easybuild-devel"))
