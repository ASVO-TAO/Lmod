...
local root = "/apps/sandybridge/software/mpi/gcc/6.4.0/openmpi/3.0.0/lalsuite-lalstochastic/1.1.20"
...
setenv("EBDEVELLALSUITEMINLALSTOCHASTIC", pathJoin(root, "easybuild/mpi-gcc-6.4.0-openmpi-3.0.0-lalsuite-lalstochastic-1.1.20-easybuild-devel"))
