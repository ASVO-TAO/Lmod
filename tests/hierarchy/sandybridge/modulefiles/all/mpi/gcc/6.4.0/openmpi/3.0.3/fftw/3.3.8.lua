...
local root = "/apps/sandybridge/software/mpi/gcc/6.4.0/openmpi/3.0.3/fftw/3.3.8"
...
setenv("EBDEVELFFTW", pathJoin(root, "easybuild/mpi-gcc-6.4.0-openmpi-3.0.3-fftw-3.3.8-easybuild-devel"))
