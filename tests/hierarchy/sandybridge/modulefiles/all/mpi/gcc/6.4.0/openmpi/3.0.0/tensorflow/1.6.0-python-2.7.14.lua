...
local root = "/apps/sandybridge/software/mpi/gcc/6.4.0/openmpi/3.0.0/tensorflow/1.6.0-python-2.7.14"
...
setenv("EBDEVELTENSORFLOW", pathJoin(root, "easybuild/mpi-gcc-6.4.0-openmpi-3.0.0-tensorflow-1.6.0-python-2.7.14-easybuild-devel"))
