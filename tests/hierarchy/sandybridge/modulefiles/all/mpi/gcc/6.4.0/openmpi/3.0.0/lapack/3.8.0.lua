...
local root = "/apps/sandybridge/software/mpi/gcc/6.4.0/openmpi/3.0.0/lapack/3.8.0"
...
setenv("EBDEVELLAPACK", pathJoin(root, "easybuild/mpi-gcc-6.4.0-openmpi-3.0.0-lapack-3.8.0-easybuild-devel"))
