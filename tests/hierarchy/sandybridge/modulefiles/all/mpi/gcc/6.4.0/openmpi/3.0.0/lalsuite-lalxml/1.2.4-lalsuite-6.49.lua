...
local root = "/apps/sandybridge/software/mpi/gcc/6.4.0/openmpi/3.0.0/lalsuite-lalxml/1.2.4-lalsuite-6.49"

conflict("lalsuite-lalxml")
...
setenv("EBROOTLALSUITEMINLALXML", root)
setenv("EBVERSIONLALSUITEMINLALXML", "1.2.4")
setenv("EBDEVELLALSUITEMINLALXML", pathJoin(root, "easybuild/mpi-gcc-6.4.0-openmpi-3.0.0-lalsuite-lalxml-1.2.4-lalsuite-6.49-easybuild-devel"))
