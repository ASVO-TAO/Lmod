...
local root = "/apps/sandybridge/software/mpi/gcc/6.4.0/openmpi/3.0.0/lalsuite-laldetchar/0.3.5"

conflict("lalsuite-laldetchar")
...
setenv("EBROOTLALSUITEMINLALDETCHAR", root)
setenv("EBVERSIONLALSUITEMINLALDETCHAR", "0.3.5")
setenv("EBDEVELLALSUITEMINLALDETCHAR", pathJoin(root, "easybuild/mpi-gcc-6.4.0-openmpi-3.0.0-lalsuite-laldetchar-0.3.5-easybuild-devel"))
