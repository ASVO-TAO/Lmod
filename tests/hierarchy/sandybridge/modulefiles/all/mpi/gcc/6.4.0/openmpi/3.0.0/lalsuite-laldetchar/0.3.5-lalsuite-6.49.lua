...
local root = "/apps/sandybridge/software/mpi/gcc/6.4.0/openmpi/3.0.0/lalsuite-laldetchar/0.3.5-lalsuite-6.49"
...
setenv("EBDEVELLALSUITEMINLALDETCHAR", pathJoin(root, "easybuild/mpi-gcc-6.4.0-openmpi-3.0.0-lalsuite-laldetchar-0.3.5-lalsuite-6.49-easybuild-devel"))
