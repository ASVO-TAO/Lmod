...
local root = "/apps/sandybridge/software/mpi/gcc/6.4.0/openmpi/3.0.0/lalsuite-lalinference/1.9.4"
...
setenv("EBVERSIONLALSUITEMINLALINFERENCE", "1.9.4")
setenv("EBDEVELLALSUITEMINLALINFERENCE", pathJoin(root, "easybuild/mpi-gcc-6.4.0-openmpi-3.0.0-lalsuite-lalinference-1.9.4-easybuild-devel"))
