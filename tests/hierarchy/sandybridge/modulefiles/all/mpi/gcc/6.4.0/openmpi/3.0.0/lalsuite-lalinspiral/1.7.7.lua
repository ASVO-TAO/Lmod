...
local root = "/apps/sandybridge/software/mpi/gcc/6.4.0/openmpi/3.0.0/lalsuite-lalinspiral/1.7.7"

conflict("lalsuite-lalinspiral")
...
if not isloaded("lalsuite-lalmetaio/1.3.1") then
    load("lalsuite-lalmetaio/1.3.1")
end
...
if not isloaded("lalsuite-lalframe/1.4.3") then
    load("lalsuite-lalframe/1.4.3")
end
...
setenv("EBROOTLALSUITEMINLALINSPIRAL", root)
setenv("EBVERSIONLALSUITEMINLALINSPIRAL", "1.7.7")
setenv("EBDEVELLALSUITEMINLALINSPIRAL", pathJoin(root, "easybuild/mpi-gcc-6.4.0-openmpi-3.0.0-lalsuite-lalinspiral-1.7.7-easybuild-devel"))
