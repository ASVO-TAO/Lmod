...
local root = "/apps/sandybridge/software/mpi/gcc/6.4.0/openmpi/3.0.0/lalsuite-lalsimulation/1.8.0"
...
setenv("EBVERSIONLALSUITEMINLALSIMULATION", "1.8.0")
setenv("EBDEVELLALSUITEMINLALSIMULATION", pathJoin(root, "easybuild/mpi-gcc-6.4.0-openmpi-3.0.0-lalsuite-lalsimulation-1.8.0-easybuild-devel"))
