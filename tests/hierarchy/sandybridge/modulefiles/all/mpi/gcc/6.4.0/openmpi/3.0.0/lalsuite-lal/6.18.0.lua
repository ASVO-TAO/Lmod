...
local root = "/apps/sandybridge/software/mpi/gcc/6.4.0/openmpi/3.0.0/lalsuite-lal/6.18.0"
...
setenv("EBVERSIONLALSUITEMINLAL", "6.18.0")
setenv("EBDEVELLALSUITEMINLAL", pathJoin(root, "easybuild/mpi-gcc-6.4.0-openmpi-3.0.0-lalsuite-lal-6.18.0-easybuild-devel"))
