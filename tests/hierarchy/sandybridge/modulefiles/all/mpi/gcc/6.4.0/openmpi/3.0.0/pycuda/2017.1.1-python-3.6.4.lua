...
local root = "/apps/sandybridge/software/mpi/gcc/6.4.0/openmpi/3.0.0/pycuda/2017.1.1-python-3.6.4"
...
setenv("EBDEVELPYCUDA", pathJoin(root, "easybuild/mpi-gcc-6.4.0-openmpi-3.0.0-pycuda-2017.1.1-python-3.6.4-easybuild-devel"))
