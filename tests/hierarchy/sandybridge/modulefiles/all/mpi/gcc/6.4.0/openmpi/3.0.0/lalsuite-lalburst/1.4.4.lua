...
local root = "/apps/sandybridge/software/mpi/gcc/6.4.0/openmpi/3.0.0/lalsuite-lalburst/1.4.4"

conflict("lalsuite-lalburst")
...
setenv("EBROOTLALSUITEMINLALBURST", root)
setenv("EBVERSIONLALSUITEMINLALBURST", "1.4.4")
setenv("EBDEVELLALSUITEMINLALBURST", pathJoin(root, "easybuild/mpi-gcc-6.4.0-openmpi-3.0.0-lalsuite-lalburst-1.4.4-easybuild-devel"))
