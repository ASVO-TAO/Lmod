...
local root = "/apps/sandybridge/software/mpi/gcc/6.4.0/openmpi/3.0.0/lalsuite-lalxml/1.2.4"
...
setenv("EBDEVELLALSUITEMINLALXML", pathJoin(root, "easybuild/mpi-gcc-6.4.0-openmpi-3.0.0-lalsuite-lalxml-1.2.4-easybuild-devel"))
