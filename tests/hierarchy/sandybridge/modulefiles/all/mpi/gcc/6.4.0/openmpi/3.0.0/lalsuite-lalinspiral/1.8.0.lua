...
local root = "/apps/sandybridge/software/mpi/gcc/6.4.0/openmpi/3.0.0/lalsuite-lalinspiral/1.8.0"
...
setenv("EBVERSIONLALSUITEMINLALINSPIRAL", "1.8.0")
setenv("EBDEVELLALSUITEMINLALINSPIRAL", pathJoin(root, "easybuild/mpi-gcc-6.4.0-openmpi-3.0.0-lalsuite-lalinspiral-1.8.0-easybuild-devel"))
