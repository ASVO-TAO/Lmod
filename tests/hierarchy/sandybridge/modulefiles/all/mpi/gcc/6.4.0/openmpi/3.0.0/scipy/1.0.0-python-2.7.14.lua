...
local root = "/apps/sandybridge/software/mpi/gcc/6.4.0/openmpi/3.0.0/scipy/1.0.0-python-2.7.14"
...
setenv("EBDEVELSCIPY", pathJoin(root, "easybuild/mpi-gcc-6.4.0-openmpi-3.0.0-scipy-1.0.0-python-2.7.14-easybuild-devel"))
