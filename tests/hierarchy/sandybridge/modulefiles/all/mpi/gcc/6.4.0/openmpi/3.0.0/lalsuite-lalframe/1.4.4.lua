...
local root = "/apps/sandybridge/software/mpi/gcc/6.4.0/openmpi/3.0.0/lalsuite-lalframe/1.4.4"

conflict("lalsuite-lalframe")
...
if not isloaded("framel/8.30") then
    load("framel/8.30")
end
...
setenv("EBROOTLALSUITEMINLALFRAME", root)
setenv("EBVERSIONLALSUITEMINLALFRAME", "1.4.4")
setenv("EBDEVELLALSUITEMINLALFRAME", pathJoin(root, "easybuild/mpi-gcc-6.4.0-openmpi-3.0.0-lalsuite-lalframe-1.4.4-easybuild-devel"))
