...
local root = "/apps/sandybridge/software/mpi/gcc/6.4.0/openmpi/3.0.0/suitesparse/5.2.0-metis-5.1.0"
...
setenv("EBDEVELSUITESPARSE", pathJoin(root, "easybuild/mpi-gcc-6.4.0-openmpi-3.0.0-suitesparse-5.2.0-metis-5.1.0-easybuild-devel"))
