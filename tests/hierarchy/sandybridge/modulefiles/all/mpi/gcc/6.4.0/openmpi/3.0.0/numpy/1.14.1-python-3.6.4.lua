...
local root = "/apps/sandybridge/software/mpi/gcc/6.4.0/openmpi/3.0.0/numpy/1.14.1-python-3.6.4"
...
setenv("EBDEVELNUMPY", pathJoin(root, "easybuild/mpi-gcc-6.4.0-openmpi-3.0.0-numpy-1.14.1-python-3.6.4-easybuild-devel"))
