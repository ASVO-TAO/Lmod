...
local root = "/apps/sandybridge/software/compiler/gcc/6.4.0/protobuf-python/3.5.1-python-3.6.4"
...
setenv("EBDEVELPROTOBUFMINPYTHON", pathJoin(root, "easybuild/compiler-gcc-6.4.0-protobuf-python-3.5.1-python-3.6.4-easybuild-devel"))
