...
local root = "/apps/sandybridge/software/compiler/gcc/6.4.0/ephem/3.7.6.0-python-2.7.14"
...
setenv("EBDEVELEPHEM", pathJoin(root, "easybuild/compiler-gcc-6.4.0-ephem-3.7.6.0-python-2.7.14-easybuild-devel"))
