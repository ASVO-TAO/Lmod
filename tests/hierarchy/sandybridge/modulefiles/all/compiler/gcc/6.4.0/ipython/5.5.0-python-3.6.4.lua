...
local root = "/apps/sandybridge/software/compiler/gcc/6.4.0/ipython/5.5.0-python-3.6.4"
...
if not isloaded("pyzmq/16.0.4-python-3.6.4-zmq4") then
    load("pyzmq/16.0.4-python-3.6.4-zmq4")
end
...
setenv("EBDEVELIPYTHON", pathJoin(root, "easybuild/compiler-gcc-6.4.0-ipython-5.5.0-python-3.6.4-easybuild-devel"))
