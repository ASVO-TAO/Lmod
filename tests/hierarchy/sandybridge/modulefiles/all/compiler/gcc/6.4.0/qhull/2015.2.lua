...
local root = "/apps/sandybridge/software/compiler/gcc/6.4.0/qhull/2015.2"
...
setenv("EBDEVELQHULL", pathJoin(root, "easybuild/compiler-gcc-6.4.0-qhull-2015.2-easybuild-devel"))
