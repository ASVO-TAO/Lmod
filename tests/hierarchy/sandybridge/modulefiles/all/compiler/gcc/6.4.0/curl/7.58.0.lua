...
local root = "/apps/sandybridge/software/compiler/gcc/6.4.0/curl/7.58.0"
...
setenv("CURL_INCLUDES", "/apps/sandybridge/software/compiler/gcc/6.4.0/curl/7.58.0/include")
