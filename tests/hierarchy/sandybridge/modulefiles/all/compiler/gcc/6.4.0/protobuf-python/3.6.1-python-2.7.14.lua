...
local root = "/apps/sandybridge/software/compiler/gcc/6.4.0/protobuf-python/3.6.1-python-2.7.14"
...
setenv("EBDEVELPROTOBUFMINPYTHON", pathJoin(root, "easybuild/compiler-gcc-6.4.0-protobuf-python-3.6.1-python-2.7.14-easybuild-devel"))
