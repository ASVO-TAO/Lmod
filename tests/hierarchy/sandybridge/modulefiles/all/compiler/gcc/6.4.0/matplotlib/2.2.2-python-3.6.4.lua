...
local root = "/apps/sandybridge/software/compiler/gcc/6.4.0/matplotlib/2.2.2-python-3.6.4"
...
setenv("EBDEVELMATPLOTLIB", pathJoin(root, "easybuild/compiler-gcc-6.4.0-matplotlib-2.2.2-python-3.6.4-easybuild-devel"))
