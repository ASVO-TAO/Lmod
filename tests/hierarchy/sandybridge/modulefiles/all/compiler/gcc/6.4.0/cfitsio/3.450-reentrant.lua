...
local root = "/apps/sandybridge/software/compiler/gcc/6.4.0/cfitsio/3.450-reentrant"
...
setenv("EBDEVELCFITSIO", pathJoin(root, "easybuild/compiler-gcc-6.4.0-cfitsio-3.450-reentrant-easybuild-devel"))
