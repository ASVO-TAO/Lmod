...
local root = "/apps/sandybridge/software/compiler/gcc/8.2.0/openmpi/4.0.0"
...
prepend_path("MODULEPATH", "/apps/sandybridge/modulefiles/all/mpi/gcc/8.2.0/openmpi/4.0.0")
