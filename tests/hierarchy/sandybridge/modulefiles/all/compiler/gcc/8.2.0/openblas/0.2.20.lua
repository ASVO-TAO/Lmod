...
local root = "/apps/sandybridge/software/compiler/gcc/8.2.0/openblas/0.2.20"
...
setenv("EBDEVELOPENBLAS", pathJoin(root, "easybuild/compiler-gcc-8.2.0-openblas-0.2.20-easybuild-devel"))
