...
local root = "/apps/sandybridge/software/compiler/gcc/5.5.0/openmpi/3.0.0"
...
prepend_path("MODULEPATH", "/apps/sandybridge/modulefiles/all/mpi/gcc/5.5.0/openmpi/3.0.0")
