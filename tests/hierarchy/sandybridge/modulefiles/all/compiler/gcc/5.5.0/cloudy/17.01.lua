...
local root = "/apps/sandybridge/software/compiler/gcc/5.5.0/cloudy/17.01"
...
setenv("CLOUDY_DATA_PATH", "/apps/sandybridge/software/compiler/gcc/5.5.0/cloudy/17.01/data")
