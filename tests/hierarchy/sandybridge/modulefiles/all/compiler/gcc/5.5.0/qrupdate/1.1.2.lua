...
local root = "/apps/sandybridge/software/compiler/gcc/5.5.0/qrupdate/1.1.2"
...
setenv("EBDEVELQRUPDATE", pathJoin(root, "easybuild/compiler-gcc-5.5.0-qrupdate-1.1.2-easybuild-devel"))
