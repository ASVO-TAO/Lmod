...
local root = "/apps/sandybridge/software/compiler/gcc/7.3.0/openmpi/3.0.3"
...
prepend_path("MODULEPATH", "/apps/sandybridge/modulefiles/all/mpi/gcc/7.3.0/openmpi/3.0.3")
