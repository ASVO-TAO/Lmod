...
local root = "/apps/sandybridge/software/compiler/intel/2016.2.181-gcc-6.4.0/gsl/2.4"
...
setenv("EBDEVELGSL", pathJoin(root, "easybuild/compiler-intel-2016.2.181-gcc-6.4.0-gsl-2.4-easybuild-devel"))
