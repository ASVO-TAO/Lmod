...
local root = "/apps/knl/software/compiler/intel/2016.2.181-gcc-6.4.0/openmpi/3.0.3"
...
prepend_path("MODULEPATH", "/apps/knl/modulefiles/all/mpi/intel/2016.2.181-gcc-6.4.0/openmpi/3.0.3")
