...
local root = "/apps/knl/software/mpi/intel/2016.2.181-gcc-6.4.0/openmpi/3.0.0/boost/1.66.0"
...
setenv("BOOST_ROOT", "/apps/knl/software/mpi/intel/2016.2.181-gcc-6.4.0/openmpi/3.0.0/boost/1.66.0")
