...
local root = "/apps/knl/software/core/ifort/2018.1.163-gcc-6.4.0"
...
prepend_path("MODULEPATH", "/apps/knl/modulefiles/all/compiler/intel/2018.1.163-gcc-6.4.0")
...
setenv("INTEL_PYTHONHOME", "/apps/knl/software/core/ifort/2018.1.163-gcc-6.4.0/debugger_2018/python/intel64")
