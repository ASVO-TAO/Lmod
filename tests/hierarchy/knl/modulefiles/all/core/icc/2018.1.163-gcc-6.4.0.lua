...
local root = "/apps/knl/software/core/icc/2018.1.163-gcc-6.4.0"
...
setenv("INTEL_PYTHONHOME", "/apps/knl/software/core/icc/2018.1.163-gcc-6.4.0/debugger_2018/python/intel64")
