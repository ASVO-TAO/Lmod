...
local root = "/apps/knl/software/core/go/1.10"

conflict("go")
prepend_path("MODULEPATH", "/apps/knl/modulefiles/all/compiler/go/1.10")
...
setenv("GOROOT", "/apps/knl/software/core/go/1.10")
