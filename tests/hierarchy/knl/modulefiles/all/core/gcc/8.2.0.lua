...
local root = "/apps/knl/software/core/gcc/8.2.0"
...
prepend_path("MODULEPATH", "/apps/knl/modulefiles/all/compiler/gcc/8.2.0")

setenv("EBROOTGCC", "/apps/knl/software/core/gcccore/8.2.0")
