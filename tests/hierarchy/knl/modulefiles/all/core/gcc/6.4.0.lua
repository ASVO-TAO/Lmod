...
local root = "/apps/knl/software/core/gcc/6.4.0"
...
prepend_path("MODULEPATH", "/apps/knl/modulefiles/all/compiler/gcc/6.4.0")

setenv("EBROOTGCC", "/apps/knl/software/core/gcccore/6.4.0")
