...
local root = "/apps/skylake/software/compiler/gcc/6.4.0/graphicsmagick/1.3.28"
...
setenv("EBDEVELGRAPHICSMAGICK", pathJoin(root, "easybuild/compiler-gcc-6.4.0-graphicsmagick-1.3.28-easybuild-devel"))
