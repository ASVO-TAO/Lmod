...
local root = "/apps/skylake/software/core/cuda/9.0.176"
...
-- prepend_path("LD_LIBRARY_PATH", pathJoin(root, "lib64/stubs/"))
setenv("CUDA_LIB_PATH", pathJoin(root, "lib64/stubs/"))

setenv("EBROOTCUDA", root)
setenv("EBVERSIONCUDA", "9.0.176")
setenv("EBDEVELCUDA", pathJoin(root, "easybuild/core-cuda-9.0.176-easybuild-devel"))
