...
local root = "/apps/skylake/software/core/cuda/9.2.88"
...
setenv("EBVERSIONCUDA", "9.2.88")
setenv("EBDEVELCUDA", pathJoin(root, "easybuild/core-cuda-9.2.88-easybuild-devel"))
