...
local root = "/apps/skylake/software/core/gcc/8.2.0"
...
prepend_path("MODULEPATH", "/apps/skylake/modulefiles/all/compiler/gcc/8.2.0")

setenv("EBROOTGCC", "/apps/skylake/software/core/gcccore/8.2.0")
