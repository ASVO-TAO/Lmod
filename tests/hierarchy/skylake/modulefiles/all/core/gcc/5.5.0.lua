...
local root = "/apps/skylake/software/core/gcc/5.5.0"
...
prepend_path("MODULEPATH", "/apps/skylake/modulefiles/all/compiler/gcc/5.5.0")

setenv("EBROOTGCC", "/apps/skylake/software/core/gcccore/5.5.0")
