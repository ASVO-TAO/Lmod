...
local root = "/apps/skylake/software/core/gcc/system"
...
prepend_path("MODULEPATH", "/apps/skylake/modulefiles/all/compiler/gcc/system")

setenv("EBROOTGCC", "/apps/skylake/software/core/gcccore/system")
