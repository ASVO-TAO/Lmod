...
local root = "/apps/skylake/software/core/gcc/6.4.0"
...
prepend_path("MODULEPATH", "/apps/skylake/modulefiles/all/compiler/gcc/6.4.0")

setenv("EBROOTGCC", "/apps/generic/software/gcccore/6.4.0")
