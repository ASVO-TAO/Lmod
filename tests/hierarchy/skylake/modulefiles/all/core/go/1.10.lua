...
local root = "/apps/skylake/software/core/go/1.10"

conflict("go")
prepend_path("MODULEPATH", "/apps/skylake/modulefiles/all/compiler/go/1.10")
...
setenv("GOROOT", "/apps/skylake/software/core/go/1.10")
