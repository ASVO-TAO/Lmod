...
local root = "/apps/skylake/software/mpi/intel/2018.1.163-gcc-6.4.0/openmpi/3.0.0/imkl/2018.1.163"
...
setenv("MKL_EXAMPLES", "/apps/skylake/software/mpi/intel/2018.1.163-gcc-6.4.0/openmpi/3.0.0/imkl/2018.1.163/mkl/examples/")
prepend_path("NLSPATH", pathJoin(root, "idb/intel64/locale/%l_%t/%N"))
setenv("MKLROOT", "/apps/skylake/software/mpi/intel/2018.1.163-gcc-6.4.0/openmpi/3.0.0/imkl/2018.1.163/mkl")
