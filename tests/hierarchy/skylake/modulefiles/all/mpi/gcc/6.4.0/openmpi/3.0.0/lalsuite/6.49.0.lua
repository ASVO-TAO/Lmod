...
local root = "/apps/skylake/software/mpi/gcc/6.4.0/openmpi/3.0.0/lalsuite/6.49.0"
...
setenv("EBVERSIONLALSUITE", "6.49.0")
setenv("EBDEVELLALSUITE", pathJoin(root, "easybuild/mpi-gcc-6.4.0-openmpi-3.0.0-lalsuite-6.49.0-easybuild-devel"))
