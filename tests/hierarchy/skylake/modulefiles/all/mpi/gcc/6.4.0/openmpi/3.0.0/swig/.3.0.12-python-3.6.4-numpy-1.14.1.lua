...
local root = "/apps/skylake/software/mpi/gcc/6.4.0/openmpi/3.0.0/swig/3.0.12-python-3.6.4-numpy-1.14.1"
...
setenv("EBDEVELSWIG", pathJoin(root, "easybuild/mpi-gcc-6.4.0-openmpi-3.0.0-swig-.3.0.12-python-3.6.4-numpy-1.14.1-easybuild-devel"))
