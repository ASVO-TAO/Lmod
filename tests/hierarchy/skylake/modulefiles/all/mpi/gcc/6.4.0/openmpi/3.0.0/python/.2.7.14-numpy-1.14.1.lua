...
local root = "/apps/skylake/software/mpi/gcc/6.4.0/openmpi/3.0.0/python/2.7.14-numpy-1.14.1"
...
setenv("EBDEVELPYTHON", pathJoin(root, "easybuild/mpi-gcc-6.4.0-openmpi-3.0.0-python-.2.7.14-numpy-1.14.1-easybuild-devel"))

-- Built with EasyBuild version 3.6.3.dev0
prepend_path("CPATH", pathJoin(root, "lib/python2.7/site-packages/numpy-1.15.4-py2.7-linux-x86_64.egg/numpy/core/include"))
prepend_path("LD_LIBRARY_PATH", pathJoin(root, "lib/python2.7/site-packages/numpy-1.15.4-py2.7-linux-x86_64.egg/numpy/core/lib"))
prepend_path("LIBRARY_PATH", pathJoin(root, "lib/python2.7/site-packages/numpy-1.15.4-py2.7-linux-x86_64.egg/numpy/core/lib"))
