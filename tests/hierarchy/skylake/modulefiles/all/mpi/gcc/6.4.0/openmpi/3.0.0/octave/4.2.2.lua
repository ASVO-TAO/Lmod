...
local root = "/apps/skylake/software/mpi/gcc/6.4.0/openmpi/3.0.0/octave/4.2.2"
...
setenv("EBDEVELOCTAVE", pathJoin(root, "easybuild/mpi-gcc-6.4.0-openmpi-3.0.0-octave-4.2.2-easybuild-devel"))
