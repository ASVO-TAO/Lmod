...
local root = "/apps/skylake/software/mpi/gcc/6.4.0/openmpi/3.0.0/openfoam/v1806-no-avx"
...
setenv("FOAM_INST_DIR", "/apps/skylake/software/mpi/gcc/6.4.0/openmpi/3.0.0/openfoam/v1806-no-avx")
setenv("WM_COMPILER", "Gcc")
setenv("WM_MPLIB", "EASYBUILDMPI")
setenv("FOAM_BASH", "/apps/skylake/software/mpi/gcc/6.4.0/openmpi/3.0.0/openfoam/v1806-no-avx/OpenFOAM-v1806/etc/bashrc")
setenv("FOAM_CSH", "/apps/skylake/software/mpi/gcc/6.4.0/openmpi/3.0.0/openfoam/v1806-no-avx/OpenFOAM-v1806/etc/cshrc")
