...
local root = "/apps/westmere/software/core/ifort/2018.1.163-gcc-6.4.0"
...
prepend_path("MODULEPATH", "/apps/westmere/modulefiles/all/compiler/intel/2018.1.163-gcc-6.4.0")
...
setenv("INTEL_PYTHONHOME", "/apps/westmere/software/core/ifort/2018.1.163-gcc-6.4.0/debugger_2018/python/intel64")
