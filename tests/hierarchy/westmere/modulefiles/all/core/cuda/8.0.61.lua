...
local root = "/apps/westmere/software/core/cuda/8.0.61"
...
setenv("EBDEVELCUDA", pathJoin(root, "easybuild/core-cuda-8.0.61-easybuild-devel"))

setenv("CUDA_HOME", "/apps/westmere/software/core/cuda/8.0.61")
