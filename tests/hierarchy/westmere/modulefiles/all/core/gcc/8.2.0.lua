...
local root = "/apps/westmere/software/core/gcc/8.2.0"
...
prepend_path("MODULEPATH", "/apps/westmere/modulefiles/all/compiler/gcc/8.2.0")

setenv("EBROOTGCC", "/apps/westmere/software/core/gcccore/8.2.0")
