...
local root = "/apps/westmere/software/core/gcc/7.3.0"
...
prepend_path("MODULEPATH", "/apps/westmere/modulefiles/all/compiler/gcc/7.3.0")

setenv("EBROOTGCC", "/apps/westmere/software/core/gcccore/7.3.0")
