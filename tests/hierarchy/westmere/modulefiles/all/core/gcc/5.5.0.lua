...
local root = "/apps/westmere/software/core/gcc/5.5.0"
...
prepend_path("MODULEPATH", "/apps/westmere/modulefiles/all/compiler/gcc/5.5.0")

setenv("EBROOTGCC", "/apps/westmere/software/core/gcccore/5.5.0")
