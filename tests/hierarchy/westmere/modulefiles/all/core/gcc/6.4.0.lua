...
local root = "/apps/westmere/software/core/gcc/6.4.0"
...
prepend_path("MODULEPATH", "/apps/westmere/modulefiles/all/compiler/gcc/6.4.0")

setenv("EBROOTGCC", "/apps/westmere/software/core/gcccore/6.4.0")
