...
local root = "/apps/westmere/software/mpi/intel/2016.2.181-gcc-6.4.0/openmpi/3.0.0/imkl/11.3.2.181"
...
setenv("MKL_EXAMPLES", "/apps/westmere/software/mpi/intel/2016.2.181-gcc-6.4.0/openmpi/3.0.0/imkl/11.3.2.181/mkl/examples/")
prepend_path("INTEL_LICENSE_FILE", "/apps/generic/licenses/intel/license.lic")
setenv("MKLROOT", "/apps/westmere/software/mpi/intel/2016.2.181-gcc-6.4.0/openmpi/3.0.0/imkl/11.3.2.181/mkl")
