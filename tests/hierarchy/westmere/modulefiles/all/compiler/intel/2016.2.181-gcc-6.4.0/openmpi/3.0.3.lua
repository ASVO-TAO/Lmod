...
local root = "/apps/westmere/software/compiler/intel/2016.2.181-gcc-6.4.0/openmpi/3.0.3"
...
prepend_path("MODULEPATH", "/apps/westmere/modulefiles/all/mpi/intel/2016.2.181-gcc-6.4.0/openmpi/3.0.3")
